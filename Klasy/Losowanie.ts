...
export default class Losowanie implements Nazwa, Tablica {
    /**
  * The object name
  */
    nazwa: string;
 ...
 */
    UstawPodglad(podglad: any): Array<number> {
        podglad.innerHTML = "";
...
*/
    UstawwTabKulki(mapa: Array<number>, tablica: Array<any>): Array<any> {
        var licznik = 0;
        var warunek = 0;
